...
const PROJECTS = {
  qiri: {
    ...
    overview: [
      ...
      "2025년 10월 20일 ~ 25일 대구 ICT 융합 엑스포에 작품을 전시하고, 일주일 동안 박람회 도우미로 선정되어 다양한 연령층(학생·전문가·고령층)에게 직접 설명을 진행했습니다. 기술 중심 설명에서 기획 의도 중심 설명으로 전환하면서, '필요한 사람에게 실질적으로 도움이 되는 앱'으로 받아들여진 경험을 통해 사용자의 상황에 맞춰 설득하는 기술의 중요성을 배웠습니다.",
    ],
    role: [
  ...
  jipchak: {
    ...
    overview: [
      ...
      "App Store 심사를 거쳐 실제 출시. 심사 과정에서 개인정보 처리방침 작성, 필수 권한 선언, 심사 거절 사유 분석까지 직접 대응하며 '동작하는 앱'과 '배포 가능한 앱'의 차이를 체감했고, 그 경험을 블로그에 정리해 심사 통과 기준과 주의사항을 기록으로 남겼습니다.",
    ],
    role: [
